...
:py:mod:`data.geographic` is a directory of modules connecting wikirepo to corresponding Wikidata features for geographic properties.
...
.. automodule:: wikirepo.data.geographic.continent
   :members:
.. automodule:: wikirepo.data.geographic.country
   :members:
